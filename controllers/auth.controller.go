...
// @Failure 400 {object} gin.H{"status": "fail", "message": "error"}
// @Failure 409 {object} gin.H{"status": "fail", "message": "User with that email already exists"}
...
// @Success 200 {object} gin.H{"status": "success", "access_token": "token"}
// @Failure 400 {object} gin.H{"status": "fail", "message": "Invalid email or Password"}
...
// @Produce json
// @Success 200 {object} gin.H{"status": "success", "access_token": "token"}
// @Failure 403 {object} gin.H{"status": "fail", "message": "Invalid or expired refresh token"}
